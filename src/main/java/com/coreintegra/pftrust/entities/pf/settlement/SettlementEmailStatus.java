...
public class SettlementEmailStatus extends BaseAuditingEntity {
    ...
    public SettlementEmailStatus(String emailId, String name, String unitCode, String pfNumber, String pernNumber,
                                 String accountNumber, String employeeBank, Date paymentDate, BigDecimal netCredit,
                                 Settlement settlement, Boolean isSent) {
