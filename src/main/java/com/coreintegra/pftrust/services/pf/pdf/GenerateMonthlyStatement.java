...
public class GenerateMonthlyStatement {
    ...
    public GenerateMonthlyStatement(PdfDocumentDesignRepository pdfDocumentDesignRepository) {
        this.pdfDocumentDesignRepository = pdfDocumentDesignRepository;
    }

    public ByteArrayOutputStream generate(MonthlyStatement monthlyStatement) throws Exception {
        return generatePDFFromJavaObject(monthlyStatement);
    }

    private ByteArrayOutputStream generatePDFFromJavaObject(MonthlyStatement monthlyStatement) throws Exception {
    ...
    private ByteArrayOutputStream getXMLSource(MonthlyStatement monthlyStatement) throws Exception {
        JAXBContext context;
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        try {
            context = JAXBContext.newInstance(MonthlyStatement.class);
