...
public class SearchSettlementSpecification {

    public Specification<Settlement> dateSpecification(JSONArray dates, String type){
    ...
    private Specification<Settlement> dateSpecification(String dateType, List<Date> selectedDates) {
    ...
    public Specification<Settlement> monthAndYearSpecification(Integer year, JSONArray months, String type){
    ...
    public Specification<Settlement> unitCodeSpecification(JSONArray jsonArray){
    ...
    public Specification<Settlement> typeSpecification(JSONArray types){
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            Join<Object, Object> join = root.join("settlementType");
    ...
    public Specification<Settlement> statusSpecification(JSONArray statusList){
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            Join<Object, Object> join = root.join("settlementStatus");
    ...
    public Specification<Settlement> employeeSpecification(Employee employee){
